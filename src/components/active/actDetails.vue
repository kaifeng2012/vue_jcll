<template>
  <div class="index-wrap2">
    <!-- 头部-->
    <router-link  to="/act" @click.native="flushCom">
      <img src="../../assets/image/index/back.png" class="back" alt="" />
    </router-link>
    <div class="topHead">
      <img :src="'http://www.shllzx.com/'+actList.fileUrl" class="banner" alt=""/>
    </div>
    <div class="tab">
    ...
    <!--替换底部导航主菜单-->
    <module v-bind:msgOfP = "msgOfP" v-on:titleChanged ="zidingyi($event,actList.id,actList.authorizationCode)"></module>
  </div>
</template>
<script>
  // 引入子组件
